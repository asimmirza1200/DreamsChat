...
import com.dreams.chat.receivers.ConnectivityReceiver;
...
public class BaseApplication extends Application implements LifecycleObserver {
    ...
    private static DatabaseReference userRef, chatRef, groupsRef, statusRef,dataRef;
    ...
    private void init() {
        ...
        dataRef = firebaseDatabase.getReference(Helper.REF_DATA);
